...
public class WeatherActivity extends Activity implements View.OnClickListener {
    private LinearLayout weatherInfoLaout;
    /**
     * 用于显示城市名
     */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //初始化控件
        weatherInfoLaout = (LinearLayout) findViewById(R.id.weather_info_layout);
        ...
        if (!TextUtils.isEmpty(countyCode)){
            ...
            weatherInfoLaout.setVisibility(View.INVISIBLE);
    ...
    /**
     * 从SharePreferences文件读取存储的天气信息，并显示到界面上
     */
