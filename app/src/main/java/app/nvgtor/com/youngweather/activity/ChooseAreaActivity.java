package app.nvgtor.com.youngweather.activity;
...
public class ChooseAreaActivity extends Activity {
    ...
    private YoungWeatherDB youngWeatherDB;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        youngWeatherDB = YoungWeatherDB.getInstance(this);
    ...
    private void queryProvinces(){
        provinceList = youngWeatherDB.loadProvinces();
    ...
    private void queryCities(){
        cityList = youngWeatherDB.loadCities(selectedProvince.getId());
        if (cityList.size() > 0){
            dataList.clear();
    ...
    private void queryCounties(){
        countyList = youngWeatherDB.loadCounties(selectedCity.getId());
        ...
        HttpUtil.sendHttpRequest(address, new HttpCallbackListener() {
            ...
            public void onFinish(String response) {
                ...
                if ("province".equals(type)){
                    result = Utility.handleProvincesResponse(youngWeatherDB, response);
                }else if ("city".equals(type)){
                    result = Utility.handleCitiesResponse(youngWeatherDB, response
                            , selectedProvince.getId());
                }else if ("county".equals(type)){
                    result = Utility.handleCountiesResponse(youngWeatherDB, response
                            , selectedCity.getId());
                }
                if (result){
